...
import 'package:my_base_flutter/theme/app_colors.dart';
import 'package:my_base_flutter/theme/app_text_theme.dart';

export 'package:my_base_flutter/theme/app_text_theme.dart' show TextStyleExt;
...
final appThemeModeProvider =
  ...
  (ref) => StateController(
      ref.read(sharedPreferencesServiceProvider).getStateTheme()
          ? ThemeMode.dark
          : ThemeMode.light),
);
